 ...
 return (
   <div className="flex flex-col md:flex-row">
     ...
     <div className="mt-4 md:mt-0 md:w-2/3 md:mx-8">
      ...
      <button className="btn btn-green mt-4 snipcart-add-item"
        ...
        data-item-url={'https://jovial-lichterman-125425.netlify.com' + data.markdownRemark.fields.slug}
      ...
      { data.markdownRemark.fields.slug === "/products/spring-jumper/" ? <ColourSelect changeColour={setColour} getColourName={getColour} /> : "" }
     </div>
   </div>
 )
}
